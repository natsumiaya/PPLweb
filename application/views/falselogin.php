...
<body>
     <center><h3 style="color:red" class="alert"><i class="icon-ban icon-big"></i>Username dan/atau Password yang dimasukkan salah</h3></center>
    <!--Header-->
            ...
            <div class="container">
                ...
                <div class="nav-collapse collapse pull-right">
                    <ul class="nav">
                        ...
                        <li class="login">
                            <a data-toggle="modal" href="#loginFalseForm"><i class="icon-lock"></i></a>
                        </li>
                    </ul>        
                </div><!--/.nav-collapse -->
            </div>
