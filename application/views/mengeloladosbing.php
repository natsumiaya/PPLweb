...
<body>
 ...
 <header class="navbar navbar-fixed-top">
    ...
    <!-- /header -->
     ...
     <section class="title">
        <div class="container">
            <div class="row-fluid">
                <div class="span6">
                    <h1><i class="icon-rocket icon-big"></i> Dosen Pembimbing</h1>
                </div>
                <div class="span6">
	...
	<a class="pull-right" data-toggle="modal" href="#insertjobForm"><i class="icon-plus icon-medium"></i>Tambahkan Dosen Pembimbing</a>
        <div class="center gap">
			<h1><i class="icon-file icon-big"></i> Daftar Dosen Pembimbing <i class="icon-file icon-big"></i>  </h1>
		</div>
        <div class="row-fluid">
           ...
           <table class="table table-hover table-bordered table-striped">
              ...
              <tbody>
                  ...
                  <td style="text-align:center;">Agus Sukron</td>
				  <td style="text-align:center;">D00001</td>
				  <td style="text-align:center;">agus@dosen.com</td>
				  <td style="text-align:center;">
					<div class="preview">
                    <img alt=" " src="<?php echo base_url();?>/assets/images/portfolio/thumb/a.jpg"  style="width:200px;height:auto;">
                    <div class="overlay">
                    </div>
                ...
                <div id="modal-7" class="modal hide fade">
                  ...
                  <td style="text-align:center;">Toto Ryuchi</td>
                  <td style="text-align:center;">D00002</td>
                  <td style="text-align:center;">tot@dosen.com</td>
                  <td style="text-align:center;">
                    <div class="preview">
                    <img alt=" " src="<?php echo base_url();?>/assets/images/portfolio/thumb/noctis.png"  style="width:200px;height:auto;">
                    <div class="overlay">
                    </div>
                </div>
                <div class="desc">
...
<div class="modal hide fade in" id="insertjobForm" aria-hidden="false">
    <div class="modal-header">
        ...
        <center><h3>Tambahkan Dosen Pembimbing</h3></center>
    </div>
    <!--Insert Body-->
...
<div class="modal hide fade in" id="updatejobForm" aria-hidden="false">
    <div class="modal-header">
        <i class="icon-remove" data-dismiss="modal" aria-hidden="true"></i>
        <h3>Edit Data Dosen Pembimbing</h3></center>
    </div>
    <!--Insert Body-->
    <div class="modal-body">
	<form style="padding-left:100px;" class="form" action="<?=base_url();?>index.php/mengelolabeasiswa/submit" method="post" id="form-insertjob">
...
<div class="modal hide fade in" id="deleteJob" aria-hidden="false">
    ...
    <div class="modal-body">
        <center><form class="form-inline" action="<?=base_url();?>index.php/mengelolabeasiswa/mengelolabeasiswa" method="post" id="deleteJob">
			<h3 style="color:red">Apakah anda yakin ingin menghapus dosen pembimbing ini?</h3>
