...
<head>
    ...
    <title>Admin's Home | SIBEA</title>
...
<section id="recent-works">
    <div class="container">
        ...
        <ul class="gallery col-4">
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="<?php echo base_url()?>assets/images/portfolio/thumb/alvinphotography.jpg">
                    <div class="overlay">
                    </div>
                    <div class="links">
                ...
                <div id="modal-1" class="modal hide fade">
                    ...
                    <div class="modal-body">
                        <img src="<?php echo base_url();?>assets/images/portfolio/full/alvinphotography.jpg" alt=" ">
                    </div>
                </div>                 
            </li>
            <!--/Item 1--> 
            ...
            <li>
                ...
                <div id="modal-2" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="<?php echo base_url();?>assets/images/portfolio/full/woroworo1.png" alt=" " width="100%" >
                    </div>
                </div>                 
            </li>
            <!--/Item 2-->
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="<?php echo base_url()?>assets/images/portfolio/thumb/woroworo2.jpg">
                    <div class="overlay">
                    </div>
                    <div class="links">
                ...
                <div id="modal-3" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="<?php echo base_url();?>assets/images/portfolio/full/woroworo2.jpg" alt=" " width="100%">
                    </div>
                </div>                 
            </li>
            <!--/Item 3--> 
            ...
            <li>
                ...
                <div id="modal-4" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="<?php echo base_url()?>assets/images/portfolio/full/chocoart.jpg" alt=" " width="100%" >
                    </div>
                </div>                 
            </li>
            <!--/Item 4-->    
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="<?php echo base_url()?>assets/images/portfolio/thumb/creativestudioUK.jpg">
                    <div class="overlay">
                    </div>
                    <div class="links">
                ...
                <div id="modal-5" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="<?php echo base_url()?>assets/images/portfolio/full/creativestudioUK.jpg" alt=" " width="100%" >
                    </div>
                </div>                 
            </li>
            <!--/Item 5-->              
