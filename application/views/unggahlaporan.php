   ...
   <section class="title">
    ...
    <section id="contact-page" class="container">
        ...
        <div class="center gap">
            <h1><i class="icon-file icon-big"></i> Mengunggah Laporan Kemajuan Kerja Praktek <i class="icon-file icon-big"></i>  </h1>
        </div>
        <div class="row-fluid">
    ...
    <form style="padding-left:100px;" class="form" action="<?=base_url();?>index.php/mengelolabeasiswa/submit" method="post" id="form-insertjob">
            <p>
                &nbsp;ID Kelompok:
                &nbsp;<input type="text" id="nama_beasiswa" class="input-small" placeholder="auto get ID" name="id kelompok" value="O001K008">
            </p>
            <p>
