    ...
    <!-- /header -->
     ...
     <section class="title">
        <div class="container">
            <div class="row-fluid">
                <div class="span6">
                    <h1><i class="icon-rocket icon-big"></i> Menunjuk Dosen Pembimbing</h1>
                </div>
                <div class="span6">
                    <ul class="breadcrumb pull-right">
                        <li><a href="Home.php">Koordinator KP</a> <span class="divider">/</span></li>
                
                        <li class="active">Menunjuk Dosen Pembimbing</li>
                    </ul>
                </div>
            </div>
        </div>
      ...
      <h1><i class="icon-file icon-big"></i> Daftar Dosen Pembimbing <i class="icon-file icon-big"></i>  </h1>
        ...
        <div class="row-fluid">
          ...
          <th style="text-align:center;width:10%;">ID</th>
                  ...
                  <th style="text-align:center;width25%;">Kelompok yang Dibimbing</th>
...
<div class="modal hide fade in" id="updatejobForm" aria-hidden="false">
    <div class="modal-header">
        ...
        <h3>Menunjuk Dosen Pembimbing</h3></center>
    </div>
    <!--Insert Body-->
