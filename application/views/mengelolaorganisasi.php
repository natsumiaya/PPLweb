...
<body>
 ...
 <header class="navbar navbar-fixed-top">
                ...
                <div class="nav-collapse collapse pull-right">
                    <ul class="nav">
                       ...
                       <li class="dropdown active">
                            <a href="#" class="dropdown-toggle " data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Kelola Dosen Pembimbing<b class=" icon-angle-down"></b></a>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle " data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Kelola Organisasi <b class=" icon-angle-down"></b></a>
                            <ul class="dropdown-menu">
    ...
    <!-- /header -->
     ...
     <section class="title">
        <div class="container">
            <div class="row-fluid">
                <div class="span6">
                    <h1><i class="icon-rocket icon-big"></i> Organisasi</h1>
                </div>
                <div class="span6">
	...
	<a class="pull-right" data-toggle="modal" href="#insertjobForm"><i class="icon-plus icon-medium"></i>Tambahkan Organisasi</a>
        <div class="center gap">
			<h1><i class="icon-file icon-big"></i> Daftar Organisasi <i class="icon-file icon-big"></i>  </h1>
		</div>
        <div class="row-fluid">
           ...
           <table class="table table-hover table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th style="text-align:center; width:15%;">Nama Organisasi</th>
				  <th style="text-align:center;width:10%;">ID</th>
                  <th style="text-align:center;width:15%;">email</th>
				  <th style="text-align:center;width:25%;">Alamat</th>
                  <th style="text-align:center;width20%;">No. Telepon</th>
              ...
              <tbody>
                  ...
                  <td style="text-align:center;">Pertamina</td>
				  <td style="text-align:center;">O001</td>
				  <td style="text-align:center;">admin@pertamina.co.id</td>
                  <td style="text-align:center;">Jl. mana saja yang penting senang 1</td>
				  <td style="text-align:center;"> +621-872618274 </td>
                  ...
                  <td style="text-align:center;">Astra Internasional</td>
                  <td style="text-align:center;">O002</td>
                  <td style="text-align:center;">admin@astra.com</td>
                  <td style="text-align:center;">Jl. hore 1</td>
                  <td style="text-align:center;"> +621-1245674 </td>
                  <td style="text-align:center;">
                    <a data-toggle="modal" href="#updatejobForm">Edit</a>
                    <a data-toggle="modal" href="#deleteJob" style="color:red">Delete</a>
                  </td>
                  ...
                  <td style="text-align:center;">O003</td>
                  <td style="text-align:center;">admin@astra.co.id</td>
                  <td style="text-align:center;">Jl. wayolo 1</td>
                  <td style="text-align:center;"> +621-872318274 </td>
                  <td style="text-align:center;">
                    <a data-toggle="modal" href="#updatejobForm">Edit</a>
                    <a data-toggle="modal" href="#deleteJob" style="color:red">Delete</a>
                  </td>
...
<div class="modal hide fade in" id="insertjobForm" aria-hidden="false">
    <div class="modal-header">
        ...
        <center><h3>Tambahkan Organisasi</h3></center>
    </div>
    <!--Insert Body-->
...
<div class="modal hide fade in" id="updatejobForm" aria-hidden="false">
    <div class="modal-header">
        <i class="icon-remove" data-dismiss="modal" aria-hidden="true"></i>
        <h3>Edit Data Organisasi</h3></center>
    </div>
    <!--Insert Body-->
    <div class="modal-body">
	<form style="padding-left:100px;" class="form" action="<?=base_url();?>index.php/mengelolabeasiswa/submit" method="post" id="form-insertjob">
...
<div class="modal hide fade in" id="deleteJob" aria-hidden="false">
    ...
    <div class="modal-body">
        <center><form class="form-inline" action="<?=base_url();?>index.php/mengelolabeasiswa/mengelolabeasiswa" method="post" id="deleteJob">
			<h3 style="color:red">Apakah anda yakin ingin menghapus data organisasi ini?</h3>
